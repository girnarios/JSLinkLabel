...
Pod::Spec.new do |s|
  s.name             = 'JSLinkLabel'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JSLinkLabel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/JSLinkLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jogendra Singh' => 'jogendra.singh@girnarsoft.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/JSLinkLabel.git', :tag => s.version.to_s }
